...
export const ProjectsAboutData = [
  ...
  {  
    id: 5,
    title: 'Feedback App',
    about: 'An app to collect customer feedback where data is stored in a mock back end using JSON-server, a github repo to data and Tipycode to connect to the "server"',
    likes: "I enjoyed learning learning about Context and how it's more suitable for smaller applications. I also liked ",
    difficulties: "",
    time: "",
    link: "https://lucianaiolos.github.io/Music-Festival-X/",
    repo: "https://github.com/LucianAiolos/Music-Festival-X",
