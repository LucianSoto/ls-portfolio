  ...
  return (
    <>
      ...
      <div className='about-container'>
        ...
        A <span className="highlight">Full Stack</span> Web Developer based in Seattle Washington.
        <br/>
        <br />
