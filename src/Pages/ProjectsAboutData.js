...
export const ProjectsAboutData = [
  // ID's need to correspond with project tile id's.
  {
    ...
    about: ` Final project for Skillspire bootcamp where I went above and beyond the given requirements and learned some authentication with NodeJS and JWTs which was quite different from firebase, and went in depth with Reduxthunk. First I set up the server, routes, models, controllers and middleware to handle CRUD operations for authentication, post creation/delete/read/updates and I used JWTs through middleware and saved the tokens to local storage. On the front end I displayed all the data and had routes for users to longin/sign-up as well as the ability to search users and display their profiles. Reduxthunk helped to asynchronously fetch and store data and handle state. Also included the ability for users to unload images for their individual posts which I accomplished by storing the images to firebase, which then gives you urls to the images that can then be used to display them on each post. `,
    likes: ' I enjoyed this project becuase I finally got to understand how user authetication is persisted over sessions. ',
    difficulties: " At one point I got really stumped with setting up the auth middleware and figuring out how to design and build schemas in order to make them relational.",
  ...
  {  
    ...
    link: "https://luciansoto.github.io/House-Marketplace/",
    repo: "https://github.com/LucianSoto/House-Marketplace",
    tools: [
      'ReactJS',
      'Firebase',
      'OAuth',
  ...
  },
  {
    ...
    link: "https://luciansoto.github.io/Crypto-Market/",
    repo: 'https://github.com/LucianSoto/Crypto-Market',
    tools: [
      'React',
      'ReCharts',
      'Coincap API',
    ...
    {  
      ...
      link: "https://luciansoto.github.io/firebase-waitlist/",
      repo: "https://github.com/LucianSoto/firebase-waitlist",
      tools: [
        "ReactJS",
        "Firebase",
        "Tailwind CSS",
    ...
    {  
      ...
      link: "https://luciansoto.github.io/Feedback-App/",
      repo: "https://github.com/LucianSoto/Feedback-App",
      tools: [
        "ReactJS",
        "JSON-Server",
        "Context",
    ...
    link: "https://luciansoto.github.io/PokeDex-Luxian/",
    repo: "https://github.com/LucianSoto/PokeDex-Luxian",
    tools: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  //   link: "https://luciansoto.github.io/Music-Festival-X/",
  //   repo: "https://github.com/LucianSoto/Music-Festival-X",
  //   tools: [
  //     "HTML",
  //     "CSS",
  //     "JavaScript"
