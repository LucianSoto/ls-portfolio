...
function AboutMe() {
  return (
    <div className='about-container'>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;Hi I'm <span >Lucian! </span> and it feels wrong to say that I am "self-taught" when I learned from several online sources and I was blessed to have a few friends give me some guidance.
      <br/>
      &nbsp;&nbsp;&nbsp;&nbsp;I am curretly working with ReactJS and have intrests in learning more about animations and effects, not to mention that I have dipped my toes in NodeJS to make a few simple fullstack applicaitons.
      <br />
      ...
      <br />
      &nbsp;&nbsp;&nbsp;&nbsp;On my free time I play badminton, and make music in my tiny home studio!
      </p>
