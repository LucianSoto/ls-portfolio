...
export const ProjectsAboutData = [
  // ID's need to correspond with project tile id's.
  {
    ...
    likes: ' I enjoyed this project becuase I finally got to understand how user authetication is persisted over sessions and periods of time. ',
    difficulties: " At one point I got really stumped with setting up the auth middleware and figuring out how design and build my schemas in order to make information attainable.",
